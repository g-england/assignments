...
function System() {
    ...
    return (
        <div>
            ...
            >
                <h1 class="text-gray-500 text-center">Step 3 - To finish up, a few bits of information from your quoted system will give us a complete picture.</h1>
            ...
            <div class="mt-5 md:mt-12 opacity-90 sm:opacity-60 md:opacity-50">
