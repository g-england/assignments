...
function sum(x, y){
    try {
        ...
        console.log("Both paramerters are numbers.")
    }
    catch(err){
        console.log(err)
    }
  ...
  //1b)  Call the sum function inside a try block using "1" and "2" 
  //     as arguments. Use console.log within a catch block to inform 
  //     the user of the error.
  try {
    var s = sum(1, 2)
  }
  catch(err){
      console.log("Both paramters must be numbers.")
  }
  finally {
      console.log(s)
