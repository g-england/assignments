//1. Given an array of numbers, return a new array that has 
...
function fiveCharactersOrFewerOnly(arr) {
    var fiveCharacters = arr.filter(word => word.length <= 5)
    return fiveCharacters
  }
  // test
console.log(fiveCharactersOrFewerOnly(["dog", "wolf", "by", "family", "eaten", "camping"]));

//4. Given an array of people objects, return a new array that
//   has filtered out all those who don't belong to the club
function peopleWhoBelongToTheIlluminati(arr){
    var notMembers = arr.filter(person => person.member === false)
    return notMembers
  }
  // test
...
//5. Make a filtered list of all the people who are old enough to see
//   The Matrix (older than 18)
function ofAge(arr){
    var over18 = arr.filter(person => person.age >= 18)
    return over18
  }
  // test
  console.log(ofAge([
